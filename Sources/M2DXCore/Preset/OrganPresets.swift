...
public extension DX7Preset {
    ...
    static let organBatch: [DX7Preset] = [
        ...
        /// All detunes sit at center (7), like the phase-locked tonewheels of the real instrument:
        /// any detune spread makes the partial crests drift into alignment over hundreds of ms,
        /// which reads (and sounds) like a slow swell instead of the instant mechanical key contact.
        /// Square envelope on every carrier — instant attack, full sustain, fast release.
        DX7Preset(
            name: "ORGAN 1",
            algorithm: 31,
            feedback: 0,
        ...
        /// Velocity sensitivity is 0 on every operator: a tonewheel organ's keys are on/off
        /// switches, so neither level nor click brightness responds to how hard you play.
        DX7Preset(
            name: "ORGAN 2",
            algorithm: 0,
            feedback: 5,
        ...
        /// Slightly softened attack (egRate1 65, ~15-20ms) models the brief mechanical lag of air
        /// filling the pipes; relaxed release (egRate4 55) decays like residual air in the windchest.
        /// All detunes sit at center (7): a detune spread made the partial crests align late, which
        /// measured (and sounded) like a 200ms swell instead of pipes speaking promptly.
